...
from errors import (AlreadyJoinedError, LobbyClosedError,LobbyNotStartedError, NoGameInChatError,
...
class GameManager(object):
    ...
    def query_game(self, user, chat):
        """ query the gameinfo """
        self.logger.info("query game with id " + str(chat.id))
