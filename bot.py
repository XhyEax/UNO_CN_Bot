...
from errors import (NoGameInChatError, LobbyClosedError,LobbyNotStartedError, AlreadyJoinedError,
                    NotEnoughPlayersError, DeckEmptyError)
from internationalization import _, __, user_locale, game_locales
from results import add_call_bluff, add_card, add_choose_color, add_draw, add_gameinfo, add_mode_classic, add_mode_fast, add_mode_text, add_mode_wild, add_no_game, add_not_started, add_other_cards, add_pass, game_info_str
...
dispatcher.add_handler(CommandHandler('query', query_game))
